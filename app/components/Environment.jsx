                ...
                <div className="flex flex-col xl:flex-row justify-center p-2 xl:pl-3 gap-2 border-gray-400">
                    <div className='grid grid-rows-2 grid-cols-2 gap-2'>
                        {enews.slice(0, 4).map((item, index) => (
                            <div key={index} className='row-span-1 col-span-1 flex flex-col justify-end border-gray-300' style={{ backgroundImage: `url(${item.image_url})`, backgroundSize: 'cover', backgroundPosition: 'center', minHeight: '300px' }}>
                    ...
                    <div className="flex flex-col  ">
                        {enews.slice(4, 10).map((item, index) => (
                            <div key={index} className='flex flex-row  border-b-2 border-gray-300 '>
